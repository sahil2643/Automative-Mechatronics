...
<main>
    ...
    <!-- Hero End -->
    <body
    class="black-bg"> <!--?  Contact Area start  -->
                    ...
                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-12 ">
                                <div class="form-group">
                                    <input class="form-control valid" style="color:white; font-size:16px;" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder="Enter your name">
                                </div>
                            </div>
                            
                            <div class="col-12">
                                <div class="form-group">
                                    <input class="form-control" style="color:white; font-size:16px;" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder="Enter Subject">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" style="color:white; font-size:16px;" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Enter Message"></textarea>
                                </div>
                            </div>
                        </div>
...
if(isset($_SESSION['email'])) {
    ?>
                                <div class="form-group">
                                    <input type="hidden" value="<?php echo $_SESSION['email']; ?>" class="form-control valid" name="email" id="email" type="hidden" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                </div>
