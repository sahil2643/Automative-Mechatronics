        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="deliveredorders.php">delivered_Orders</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="rejectorders.php">reject_Orders</a>
              </li>
            </ul>
            <?php
